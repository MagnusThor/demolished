...
const ColorPicker_1 = require("./pickers/ColorPicker");
const FloatPicker_1 = require("./pickers/FloatPicker");
const Vec2Picker_1 = require("./pickers/Vec2Picker");
const Vec2Picker_2 = require("./pickers/Vec2Picker");
const Color_1 = require("./pickers/types/Color");
class DemoishedEditorHelper {
    constructor(editor) {
        this.editor = editor;
        this.wrapper = editor.getWrapperElement();
        let style = window.getComputedStyle(this.wrapper, null);
        let bgColor = new Color_1.default(style.background !== '' ? style.background : style.backgroundColor);
        let fgColor = new Color_1.default(style.color);
        this.properties = {
        ...
        this.wrapper.addEventListener('mouseup', (event) => {
            ...
            if (match) {
                ...
                if (match.type === 'color') {
                    this.activeModal = new ColorPicker_1.default(match.string, this.properties);
                    ...
                    this.activeModal.on('link_button', (color) => {
                        this.activeModal = new Vec2Picker_2.default(color.getString('vec'), this.properties);
                        this.activeModal.showAt(this.editor);
                ...
                if (match.type === 'vec3') {
                    this.activeModal = new Vec2Picker_2.default(match.string, this.properties);
                    this.activeModal.showAt(this.editor);
                    this.activeModal.on('changed', (dir) => {
                        let newDir = dir.getString('vec3');
                        let start = { line: cursor.line, ch: match.start };
                    ...
                    this.activeModal = new Vec2Picker_1.default(match.string, this.properties);
                    this.activeModal.showAt(this.editor);
                    ...
                    this.activeModal = new FloatPicker_1.default(match.string, this.properties);
                    this.activeModal.showAt(this.editor);
